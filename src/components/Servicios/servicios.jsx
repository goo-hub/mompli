  ...
  return (
    <section className="container mx-auto pt-8 lg:pt-16 px-5 lg:px-28 2xl:px-8">
      <div className="container mx-auto ">
        <h2 className="text-primary font-bold text-right lg:text-left uppercase text-2xl md:text-6xl">
          Nuestros servicios
        </h2>

        <div className="w-full border-t border-primary">
          <div className="flex justify-between pt-6 relative">
            <div className="w-[1px] h-16 -rotate-45 absolute -top-2 left-6 bg-primary">
              &nbsp;
            </div>
          </div>
        </div>
      ...
      <div className="group pt-8 lg:pt-16">
        ...
        <div className="hidden lg:grid grid-cols-4 gap-4">
          ...
          {tabsData[activeTab].map((item, idx) => (
            ...
            >
              <h4 className="font-medium font-geraldton text-lg">
                {item.title}
              </h4>
              <img
                src={item.image}
